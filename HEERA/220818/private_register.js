            ...
            docRef.get().then((doc) => {
                ...
                // console.log("Document data:", doc.data());
                    ...
                    if(doc.data().level > 1){
                        ...
                        const header_res_btn = document.querySelector("#header_res_btn");
                        const input_timetable_img = document.querySelector("#input_timetable_img");
                        const del_data = document.querySelector("#del_data");
                        header_res_btn.style.display = 'none';
                        input_timetable_img.style.display = 'none';
