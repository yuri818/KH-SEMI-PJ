      ...
      firebaseDatabase.ref("users/" + user.uid).once('value').then(function (snapshot) {
        ...
        docRef.get().then((doc) => {
          if (doc.exists) {
            ...
            document.getElementById("user_pw").textContent = "성별: "+ doc.data().gender;
          } else {
              ...
              for(let i=0; i<total; i++){
                ...
                const template =`
                                <div class="list-group-branch">
                                  ...
                                  <button type="button" class="btn btn-primary btn-sm"><a href="./cs-modal-modify.html?id=${snapshot.docs[i].id}">상세보기</a></button>
                                </div>
                `
